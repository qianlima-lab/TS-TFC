            ...
            if epoch < args.warmup_epochs:
                for x, y in train_labeled_loader:
                    ...
                    if len(y) > 1:
                        ...
                        step_loss = step_loss + batch_sup_contrastive_loss * args.sup_con_lamda
